...
⛔ **Et le manque ne se comble jamais.** *Ni ici, ni plus tard. C'est le fil qui traverse les trois chapitres sans être nommé : un homme qui retourne voir un gosse parce qu'il n'a pas su remplir une case.*`,
  garde_forme: `**Le déroulé, tel que l'autrice l'a posé :** ① il sonne, June ouvre sans surprise — description très brève ; ② Eliott, et c'est là que le lecteur le voit vraiment pour la première fois ; ③ ils sortent — **l'aquarium, décision du 22 août 2026** : *des couloirs sombres, l'apaisement, de quoi glisser de belles descriptions pendant qu'on traite la mélancolie du garçon* ; ④ au retour, l'école et le gymnase, en passant — **et le contraste est le sujet du chapitre** : *le calme sombre à l'aller, la cour éclairée au retour, et un gosse qui n'a le droit ni de l'un ni de l'autre.*
...
**Fin proposée :** *ils rentrent, Eliott passe la porte, Andrew reste une seconde devant.* **« Il ne compta pas les pas du retour »** — l'écho du chapitre premier dit qu'il est ailleurs sans dire où. ⛔ *Et le chapitre ne se ferme pas chez lui : le lecteur ne doit jamais voir où Andrew habite.*`,
  monde: `Le métier de berceuse vu de l'intérieur : une maison à côté du jardin, quelqu'un qui a la charge de trois personnes. Et l'école, depuis la rue, en longeant la grille — **celle où Eliott n'ira jamais.**`,
  ...
  ouvert: [`⚠️ **Ce que l'aquarium fait à un garçon qui s'est noyé, et l'autrice n'a pas encore tranché.** *La peur de l'eau est son reliquat corporel — elle produit une colère noire au cours de natation.* **Ma lecture : l'eau derrière une vitre n'est pas l'eau où l'on entre, et un noyé peut la regarder.** *Alors l'aquarium apaise, comme elle le veut, et le lecteur ne comprendra qu'à la relecture.* ⚠️ **Reste à savoir si la scène se place avant ou après le cours de natation.**`,
