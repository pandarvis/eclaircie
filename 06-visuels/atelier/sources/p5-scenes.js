...
**Fin proposée :** *ils rentrent, Eliott passe la porte, Andrew reste une seconde devant.* **« Il ne compta pas les pas du retour »** — l'écho du chapitre premier dit qu'il est ailleurs sans dire où. ⛔ *Et le chapitre ne se ferme pas chez lui : le lecteur ne doit jamais voir où Andrew habite.*`,
  ...
  gardes: [
    ...
    `❓ **Le mot berceuse n'apparaît nulle part dans le chapitre, et c'est volontaire pour l'instant.** *Le lecteur voit une femme qui a trois jeunes à charge et un métier ; le titre du métier peut attendre d'avoir une raison d'être dit.* ⚠️ **À trancher : le faire tomber ici dans une réplique, ou le laisser venir plus tard.**`,
