...
**Fin proposée :** *ils rentrent, Eliott passe la porte, Andrew reste une seconde devant.* **« Il ne compta pas les pas du retour »** — l'écho du chapitre premier dit qu'il est ailleurs sans dire où. ⛔ *Et le chapitre ne se ferme pas chez lui : le lecteur ne doit jamais voir où Andrew habite.*`,
  ...
  gardes: [
    ...
    `✅ **Le mot berceuse tombe dans le portrait de June — tranché le 22 août 2026.** *On est chez Andrew : il sait qui elle est, il n'a pas à le découvrir.* **Même régime que le veilleur du prologue : un métier se nomme, il ne s'explique pas.**`,
    `🔴 **Et la phrase pose l'inversion des âges une seconde fois, sans commentaire :** *« Vingt-deux ans, à peu près, et berceuse depuis plus longtemps que ça. »* ⛔ **Personne ne relève, le narrateur n'y revient pas.** *Le chapitre premier l'a déjà fait chez les préparateurs ; c'est une confirmation, pas une révélation.*`,
