...
**Fin proposée :** *ils rentrent, Eliott passe la porte, Andrew reste une seconde devant.* **« Il ne compta pas les pas du retour »** — l'écho du chapitre premier dit qu'il est ailleurs sans dire où. ⛔ *Et le chapitre ne se ferme pas chez lui : le lecteur ne doit jamais voir où Andrew habite.*`,
  ...
  gardes: [
    ...
    `🔴 **Deux ou trois gestes qu'il ne devrait pas connaître, et pas un de plus.** *Décision de l'autrice, 22 août 2026.* **Des gestes, jamais des savoirs** — *un savoir se vérifie, un geste n'est qu'une bizarrerie d'enfant.* Retenus : **il fredonne un air que personne ne reconnaît et ne sait pas ce que c'est** ; **il sait siffler entre ses doigts** ; **il s'arrête au bord de la chaussée et cherche quelque chose qui n'y est pas.**`,
    `⛔ **Et le narrateur ne nomme jamais ce qu'il cherche.** *Andrew n'a jamais vu de feu tricolore : il ne peut pas en nommer un, donc le texte ne le peut pas non plus.* **On écrit le geste sans son objet** — il s'arrête, il lève les yeux vers le haut d'un poteau, il regarde des deux côtés, et il finit par contourner. *C'est le lecteur qui remplit, et il remplit tout seul.*`,
  ...
  ouvert: [`⚠️ **Combien de lieux du rituel sont montrés.** *Un seul, nommé, et le reste en passant ? Ou trois, ce qui commence à faire une visite guidée.*`,
           `⚠️ **Lequel des trois gestes tombe ici et lesquels attendent la tournée.** *Les trois d'affilée dans le même chapitre feraient série.*`],
