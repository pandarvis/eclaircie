...
/* ---------- LE MONDE COMME TERRAIN ---------- */
{
  ...
  gardes: [
    ...
    `⚠️ **Le portage d'Eliott n'est pas un métier, c'est ce qui reste.** *Décision de l'autrice, 23 août 2026 : on quitte son métier à douze ans, quel qu'il soit, et entre douze et huit on est affecté à des tâches simples.* **Henri emploie donc des gens qui ont quitté autre chose** — *et il n'a aucune raison de le dire, puisque tout le monde le sait.*`,
