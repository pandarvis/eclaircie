...
⛔ **Rien de la maison ne se redécrit** — *il n'y met pas les pieds, et c'est ce qui permet de revenir au même endroit deux chapitres de suite sans que ça pèse.* ✅ **Le vide de la scène suivante ne se sent que si la place était pleine.**`,
    ...
    `🔴 **Siffler quelqu'un n'est pas inhabituel ici : c'est déplacé.** *Précision de l'autrice, 23 août 2026 : « on siffle un chien, un chat si on veut, mais pas quelqu'un ».* **Deux personnes se retournent sur le trottoir d'en face**, et Andrew met un temps à repartir. *On sifflait un chien, un cheval qui s'éloignait ; pour aller chercher quelqu'un, on disait son nom.*

✅ **Et Julie ne s'en offusque pas** — *elle cherche d'où ça vient, elle les trouve, et elle n'a l'air surprise qu'une seconde.* **Entre eux ça passe ; c'est le reste de la rue qui se retourne.** ⛔ *Le garçon ne se doute de rien, et personne ne le lui dit.*`,
