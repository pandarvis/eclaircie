...
[`p`,`La ligne était partie aux archives avec celles de la semaine, et le blanc du bout avec elle. Personne ne le lui avait fait remarquer. Une case d'observations qu'on laisse vide ne manque à personne : elle dit qu'il n'y avait rien à observer.`],
[`pause`,`· · ·`],
[`p`,`La rue des berceuses tenait d'un seul tenant. Des maisons serrées épaule contre épaule, une porte en bas, des fenêtres en haut, et devant chacune un carré de terre large comme une table. Celle de June était la troisième.`],
[`p`,`Il sonna.`],
[`p`,`Elle ouvrit avec un torchon à la main, s'écarta de ce qu'elle put, et repartit vers le fond du couloir.`],
[`tiret`,`— Julie, les pieds.`],
[`p`,`Une voix répondit quelque chose depuis l'étage, sur le ton de quelqu'un qui a déjà répondu. Andrew referma derrière lui et suivit June, parce que le couloir n'allait nulle part ailleurs.`],
[`p`,`La cuisine tenait dans ce qui restait de la maison. Trois assiettes séchaient sur une planche, la dernière encore mouillée. June reprit là où elle s'était arrêtée.`],
[`tiret`,`— Il est en haut. Il descendra.`],
[`p`,`Sur la table, un cahier ouvert et un crayon posé en travers, la mine vers la fenêtre. Andrew resta debout à côté de la chaise et ne s'assit pas.`],
[`tiret`,`— Paul s'en va dans trois semaines. Ou quatre, ça dépendra de la place.`],
[`tiret`,`— Il le sait ?`],
[`tiret`,`— Il compte les jours à l'envers depuis un mois.`],
[`p`,`Elle posa l'assiette sur la pile et garda la main dessus une seconde de trop.`],
[`tiret`,`— Lui, il ne va pas fort en ce moment.`],
[`p`,`Elle ne dit pas qui, et elle n'eut pas à le dire.`],
[`tiret`,`— Il vous parle, à vous.`],
[`p`,`Elle dit ça comme on dit qu'il va pleuvoir, en pliant son torchon en carré, et elle passa à autre chose.`],
[`pause`,`· · ·`],
[`p`,`L'escalier fit du bruit. Eliott descendit les dernières marches d'un coup, s'arrêta sur la troisième en partant du bas et regarda qui c'était.`],
...
[`p`,`Son visage était doux, encore rond aux joues, avec un nez court et droit et une bouche fine. Quelqu'un qui savait le faire lui avait coupé les cheveux, et ils repartaient quand même en mèches sur le front et sur les oreilles. Ce qui tenait le visage, c'étaient les yeux. Clairs, larges, et ils prenaient toute la place.`],
[`p`,`Le reste était mince sans être maigre. Épaules étroites, poignets étroits, des mains encore petites. Il tenait la rampe à pleines mains, comme à la table, un mois plus tôt. Il y avait dans sa façon de se tenir quelque chose qui cherchait encore sa forme.`],
[`p`,`Andrew l'avait déjà vu regarder, sous la serviette, et il regardait mieux qu'il n'en avait l'air.`],
[`tiret`,`— Bonjour.`],
[`tiret`,`— Bonjour.`],
[`p`,`Julie passa derrière lui, prit une pomme dans le panier et remonta sans s'arrêter. Elle avait son âge et elle était chez elle.`],
[`p`,`Eliott la suivit des yeux jusqu'à ce que la porte claque, en haut.`],
[`tiret`,`— Elle a eu un métier, dit-il. Avant. Elle dit qu'elle réparait des toits.`],
[`tiret`,`— Ça arrive.`],
[`tiret`,`— Elle a dix ans.`],
[`p`,`Andrew hocha la tête. Le garçon attendit encore un peu, puis il lâcha la rampe.`],
[`pause`,`· · ·`],
[`tiret`,`— On sort ?`],
[`p`,`Eliott regarda June, qui lui montra la porte avec le menton.`],
[`tiret`,`— On va où ?`],
[`tiret`,`— Tu verras.`],
[`tiret`,`— Je déteste quand tu dis ça.`],
[`p`,`Il s'assit par terre dans le couloir pour mettre ses chaussures, et il mit plus de temps qu'il n'en fallait. June rouvrit la porte pour eux et la tint jusqu'à ce qu'ils soient dehors tous les deux.`],
