...
[`p`,`Sur les murs, des tableaux de marqueterie. Pas de peinture : des essences de bois taillées en feuilles minces, assemblées bord à bord sur leur support, puis raclées jusqu'à ce qu'on ne sente plus les joints sous la main. Toutes les couleurs venaient du bois.`],
[`p`,`Ceux-là montraient des montagnes qui n'existaient nulle part. Des versants blonds, des ombres tirées d'une essence presque noire, des ciels veinés qu'aucun ciel n'a jamais eus. On s'arrêtait parfois devant sans savoir ce qui avait retenu le regard — la matière, ce qu'elle représentait, ou les deux.`],
