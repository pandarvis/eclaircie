...
[`p`,`Le lieutenant sortit un carnet et le posa sur la table.`],
...
[`tiret`,`— Je l'ai.`],
[`tiret`,`— Alors ?`],
[`p`,`Il n'avait rien dit depuis qu'ils étaient entrés.`],
[`tiret`,`— Ce n'est pas les heures qui m'intéressent.`],
[`p`,`June se tourna vers lui.`],
[`tiret`,`— Il m'a déjà demandé comment il était. J'ai répondu.`],
[`tiret`,`— Vous avez répondu quoi ?`],
[`tiret`,`— Distant.`],
[`tiret`,`— Et après ?`],
[`p`,`Elle ouvrit la bouche et la referma.`],
[`tiret`,`— Après, il est passé à autre chose.`],
[`p`,`Le lieutenant ne dit rien et ne leva pas les yeux de son carnet.`],
[`tiret`,`— Alors reprenons à distant. Distant comment ?`],
[`p`,`June s'assit à la table, en face d'eux.`],
...
[`tiret`,`— Avec moi il parle un peu plus. Mais il ne raconte rien non plus.`],
[`tiret`,`— Un peu plus, c'est-à-dire ?`],
[`tiret`,`— Il me demande ce que je couds. Il regarde. Des fois il tient le tissu.`],
[`p`,`Elle réfléchit à ce qu'elle venait de dire.`],
[`tiret`,`— C'est moi qui parle, en fait.`],
[`pause`,`· · ·`],
[`tiret`,`— Il y a autre chose. Quelque chose qui aurait changé, ces dernières semaines.`],
[`p`,`Elle allait répondre non.`],
...
[`tiret`,`— Je lui ai monté une assiette. Je l'ai redescendue le lendemain matin, pleine.`],
[`tiret`,`— Et le lendemain ?`],
[`tiret`,`— Le lendemain il était comme avant. Il a débarrassé. Il m'a demandé s'il pouvait sortir.`],
[`p`,`Elle laissa passer un temps.`],
[`tiret`,`— Comme si ça n'avait pas eu lieu.`],
[`tiret`,`— C'était quand ?`],
[`tiret`,`— La semaine dernière. Je ne sais plus quel jour.`],
[`p`,`Le lieutenant écrivit trois lignes, releva la tête et regarda l'escalier.`],
...
[`tiret`,`— Ça, en revanche, il y passe des heures. Il en est aux lettres, alors il regarde les images. Il peut rester sur la même page.`],
...
[`p`,`Le policier ouvrit le tiroir de la table. Les feuilles y étaient empilées sur deux ou trois centimètres. Il les repoussa et souleva une boîte en fer.`],
[`tiret`,`— Ça, c'est quoi ?`],
[`tiret`,`— Sa paye. Il la met là. Il ne dépense presque rien.`],
[`p`,`Il compta sans rien sortir de la boîte.`],
[`tiret`,`— Il en manque ?`],
[`tiret`,`— Non. Il a été payé en fin de semaine, et tout y est.`],
[`p`,`Andrew n'avait pas quitté la porte. Une nageoire dépassait de sous l'oreiller, bleue, avec des stries plus claires.`],
[`tiret`,`— Et ça ?`],
[`p`,`Le policier souleva l'oreiller.`],
[`tiret`,`— Son poisson.`],
[`p`,`June vint le prendre et le garda contre elle sans s'en apercevoir.`],
...
[`tiret`,`— Trois semaines. Il a insisté pour que je l'emmène en ville, il l'avait repéré dans une boutique.`],
[`p`,`Elle tourna la peluche dans ses mains.`],
[`tiret`,`— C'est la seule fois où il m'a demandé quelque chose.`],
[`p`,`Le policier écrivait.`],
[`tiret`,`— Il y en avait un panier entier. Des bleus, des orange, des mélangés. Ils avaient tous…`],
[`tiret`,`— Une petite vague brodée sur la nageoire de gauche.`],
[`p`,`June leva la tête.`],
[`tiret`,`— Comment vous savez ça ?`],
[`tiret`,`— C'est la marque du magasin. Elle est sur tout ce qu'ils vendent.`],
[`p`,`Il y avait une boutique à côté de l'aquarium, une petite, avec deux paniers dehors et le reste en vitrine. Ils étaient passés devant en sortant. Le garçon s'était arrêté, avait regardé les paniers, et n'avait rien demandé.`],
[`p`,`Andrew ne dit pas qu'il y était passé avec lui.`],
...
[`tiret`,`— Julie, est-ce qu'il t'a parlé, ces derniers jours ? demanda Andrew.`],
...
[`p`,`Le policier tourna une page et n'écrivit rien dessus.`],
[`tiret`,`— Il y en avait un troisième ici.`],
[`tiret`,`— Paul. Il est parti au jardin vendredi.`],
[`tiret`,`— Il faudrait peut-être le…`],
...
[`p`,`Andrew avait posé la phrase comme on pose une pièce sur une table.`],
[`tiret`,`— Oui.`],
[`tiret`,`— C'était la première fois ?`],
[`tiret`,`— La première dont j'entends parler.`],
[`tiret`,`— Vous en savez quoi, exactement ?`],
[`tiret`,`— Ce que j'ai vu. Il est rentré la veille avec les genoux en sang et la lèvre fendue.`],
[`p`,`Le veilleur se redressa sur sa chaise.`],
[`tiret`,`— La veille de sa disparition ?`],
[`tiret`,`— La veille.`],
...
[`tiret`,`— Sa paye est dans le tiroir, entière. Il n'a pas emporté un vêtement. Il est parti du dépôt à l'heure, comme tous les jours, et il y a quinze minutes de marche entre là-bas et cette porte. Il les fait depuis un mois, deux fois par jour.`],
