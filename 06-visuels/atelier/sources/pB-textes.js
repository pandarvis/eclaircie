...
[`p`,`Il y eut d'autres fois. À un moment, sans que ni l'un ni l'autre l'ait décidé, le garçon cessa de le vouvoyer. Andrew ne s'en aperçut que deux jours plus tard.`],
[`p`,`Ce jour-là, il le rejoignit sur sa tournée.`],
[`p`,`Eliott l'attendait au coin de la rue, la sacoche en travers du corps. Il dit bonjour et repartit sans attendre.`],
[`p`,`Il avait le visage des mauvais jours.`],
[`p`,`La sacoche s'ouvrait sur le devant. Dedans, des enveloppes tenues par une pince, et au fond trois paquets rangés dans l'ordre où il les livrerait.`],
[`p`,`Il connaissait les boîtes. Il savait laquelle s'ouvrait mal, laquelle prenait les gros et laquelle il fallait pousser par en dessous. Devant l'une il se mit sur la pointe des pieds ; devant une autre il s'accroupit sans ralentir.`],
...
[`p`,`Andrew avait relevé assez d'âges pour savoir ce que ça valait. Chez les grands nombres, la descente se tenait : régulière, prévisible d'une année sur l'autre, et il n'y avait qu'à laisser faire. Chez les petits, elle faisait ce qu'elle voulait. On l'avait constaté ; personne n'avait jamais dit pourquoi.`],
...
[`p`,`Eliott la retourna, vérifia, et la glissa dans le rabat du fond, celui qui repartait au centre de tri.`],
[`tiret`,`— Merci mon grand.`],
[`p`,`Il ne répondit pas. Ils repartirent.`],
...
[`tiret`,`— Ben oui.`],
[`p`,`Il haussa les épaules comme si la question était bête, et c'était peut-être le cas.`],
[`p`,`Il connaissait son quartier par cœur. Il savait chez qui il fallait sonner deux fois, laquelle des maisons de la rangée haute avait un chien qui n'aboyait jamais, et quelle porte s'ouvrait avant qu'on ait posé le paquet. Henri lui avait ajouté deux rues le mois d'avant, puis une troisième la semaine passée.`],
...
[`p`,`Il s'arrêta et regarda la devanture. Il inspira un coup.`],
[`tiret`,`— Il y avait un magasin de chaussures, ici… Bon. C'est pas grave, j'ai rien à y livrer de toute façon.`],
[`p`,`Il repartit sans y jeter un œil.`],
[`p`,`Andrew regarda la vitrine en passant. Des cageots sur le trottoir, un panneau écrit à la craie, une femme qui rentrait des caisses vides.`],
[`p`,`Le garçon avait déjà repris sa phrase là où il l'avait laissée, et parlait de la rangée du haut où personne ne descendait jamais chercher son courrier.`],
[`p`,`Il parlait plus, maintenant. Il parlait de tout, et il tournait autour de quelque chose.`],
[`tiret`,`— Nicolas, il fait quoi ?`],
[`tiret`,`— Nicolas ?`],
[`tiret`,`— L'autre. Celui qui est arrivé avec moi.`],
[`p`,`Andrew chercha un instant.`],
[`tiret`,`— Je ne sais pas. Il est parti chez un tuteur.`],
[`tiret`,`— Il va apprendre un métier.`],
[`tiret`,`— Sûrement.`],
[`tiret`,`— Un vrai.`],
[`p`,`Ils firent quelques mètres.`],
[`tiret`,`— Le mien, c'est pas un vrai.`],
[`tiret`,`— C'en est un.`],
[`tiret`,`— On me l'a donné. On m'a pas demandé.`],
[`p`,`Il donna un coup de pied dans un caillou qui ne partit pas.`],
...
[`p`,`Le garçon ouvrit la bouche, et rien ne sortit.`],
[`tiret`,`— Je sais pas.`],
[`p`,`Il repartit d'un pas plus vif, et Andrew le laissa prendre deux mètres avant de le rattraper.`],
...
[`p`,`Le garçon s'arrêta net, mit deux doigts dans sa bouche et siffla.`],
[`p`,`Le son partit d'un coup et traversa toute la rue. Deux personnes se retournèrent sur le trottoir d'en face. Trente mètres plus haut, Julie chercha d'où ça venait, les trouva, et n'eut l'air surprise qu'une seconde.`],
[`tiret`,`— Tu vas où ?`],
[`tiret`,`— June m'a demandé de récupérer du lait !`],
[`tiret`,`— Prends le gros !`],
[`p`,`Elle leva son filet vide pour dire qu'elle avait entendu, et repartit.`],
[`p`,`Andrew n'avait pas bougé.`],
[`p`,`Le garçon s'en aperçut et remit la sacoche en place.`],
...
[`p`,`C'étaient les deux doigts. La façon de les plier, de les poser sous la langue, de souffler d'un seul coup sec. Ces choses-là s'apprennent, et elles s'apprennent de quelqu'un.`],
[`tiret`,`— Qui t'a montré ?`],
[`tiret`,`— Quoi ?`],
[`tiret`,`— À faire ça avec les doigts.`],
[`p`,`Eliott haussa les épaules.`],
[`tiret`,`— Je sais pas. Je sais le faire.`],
[`p`,`Il repartit sans se douter de rien, et Andrew le suivit.`],
[`p`,`La sacoche était vide quand ils arrivèrent devant chez June.`],
[`p`,`Le garçon monta les marches, sonna, et se retourna à moitié.`],
[`tiret`,`— Salut.`],
[`p`,`La porte s'ouvrit et il entra sans attendre. On l'entendit monter l'escalier, puis une porte se ferma en haut.`],
[`p`,`June resta sur le seuil, la main sur le montant, à regarder le plafond du couloir comme si elle pouvait voir à travers.`],
[`tiret`,`— Vous avez cinq minutes ?`],
[`p`,`Andrew fit oui de la tête. Elle sortit, tira la porte derrière elle et s'assit sur la deuxième marche. Il s'assit à côté d'elle.`],
[`tiret`,`— Il a été comme ça toute la journée ?`],
[`tiret`,`— Toute la semaine.`],
[`p`,`Elle passa les mains sur son tablier, sans rien à essuyer dessus.`],
[`tiret`,`— J'en ai eu six avant lui. Six, en comptant Paul et Julie. Il y en a eu des difficiles, il y en a eu qui pleuraient les premiers jours, il y en a eu un qui n'a pas parlé pendant deux semaines, mais c'est tout. Ça s'est toujours arrangé. Toujours.`],
[`tiret`,`— Et là.`],
[`tiret`,`— Là, non.`],
[`p`,`Elle regarda la rue.`],
[`tiret`,`— Ce n'est pas qu'il est méchant. Il n'est pas méchant du tout. Il dit bonjour, il mange, il aide quand on lui demande. Julie l'adore, elle lui reprend ses affaires, elle lui garde une place. Paul essaie, à sa façon.`],
[`tiret`,`— Et lui ?`],
...
[`p`,`Il attendit un peu avant de parler.`],
[`tiret`,`— Il m'a dit une chose, tout à l'heure. Que personne ne lui avait demandé ce qu'il voulait faire.`],
[`tiret`,`— Le portage ?`],
[`tiret`,`— Le portage.`],
[`p`,`June ne répondit pas tout de suite.`],
[`tiret`,`— Il a raison. À son âge, on attribue.`],
[`tiret`,`— Et vous ?`],
[`tiret`,`— Moi, j'ai choisi.`],
[`p`,`Elle le dit sans détour, et sans en tirer fierté.`],
[`tiret`,`— J'ai eu l'école, j'ai eu le temps de regarder autour. J'ai vu travailler une berceuse et j'ai su. Lui, il n'aura rien vu du tout.`],
[`p`,`Elle posa les coudes sur ses genoux et regarda ses mains.`],
...
[`p`,`Elle laissa passer un moment.`],
[`tiret`,`— Ça expliquerait le reste ?`],
[`tiret`,`— Une partie.`],
[`p`,`Il n'ajouta pas ce qu'il pensait. Que ça n'expliquait pas le premier jour, ni ce qu'il avait vu à la table sans savoir quoi en faire.`],
[`p`,`Ils restèrent un moment sans rien dire. Quelqu'un tondait, deux ou trois maisons plus loin.`],
[`tiret`,`— Il a fini par me sortir une chose, hier soir, reprit June.`],
[`p`,`Elle attendit.`],
[`tiret`,`— Que les autres, au travail, le traitaient de porteur de voiles.`],
[`p`,`Elle le dit plus bas, comme on rapporte un mot qu'on ne dirait pas soi-même.`],
