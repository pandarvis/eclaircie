...
[`p`,`Andrew n'eut pas le temps de répondre. Le garçon s'arrêta net, mit deux doigts dans sa bouche et siffla.`],
[`p`,`Le sifflement traversa la rue. Julie se retourna, trente mètres plus haut, un filet vide à la main.`],
[`tiret`,`— Tu vas où ?`],
[`tiret`,`— June m'a demandé de récupérer du lait !`],
[`tiret`,`— Prends le gros !`],
[`p`,`Elle leva le filet pour dire qu'elle avait entendu, et repartit.`],
...
[`p`,`On appelait les gens par leur nom, ou on marchait jusqu'à eux. Andrew n'en fit rien.`],
