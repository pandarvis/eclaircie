...
[`tiret`,`— À cet âge-là, on agit d'abord. Une contrariété, quelque chose qu'on ne digère pas, et on part. Les quatre cents coups, moi aussi, je les ai faits en mon temps.`],
[`p`,`Il eut un petit rire par le nez et se toucha la tempe.`],
[`tiret`,`— Et puis franchement, ils ne se rendent pas compte. On ne réfléchit pas, là-haut. Les conséquences, ça vient après…`],
...
<strong>① <em>Les quatre cents coups, moi aussi, je les ai faits en mon temps.</em></strong> ⚠️ <em>Il place sa jeunesse derrière lui.</em> <strong>Chez Andrew, on n'a pas été jeune : on le devient</strong> — <em>et personne n'y possède un temps révolu.</em>

⚠️ <strong>Deux mots ont changé le 25 août 2026 :</strong> <em>avec le temps est devenu en mon temps, qui dissone plus fort, et l'expression a pris la place de</em> des bêtises <em>au lieu de s'y ajouter.</em> ⛔ <strong>Sinon elle redisait ce que la réplique venait de dire</strong> — <em>l'erreur exacte qui a fait sauter</em> génération.

📌 <strong>Sur l'origine, et il faut le savoir : elle est douteuse.</strong> <em>On raconte partout que Louis XIII fit tirer quatre cents coups de canon sur Montauban en 1621, sans faire céder la ville.</em> ⚠️ <strong>Mais l'expression n'est attestée au sens actuel qu'au XIX<sup>e</sup> siècle</strong>, <em>et</em> quatre cents <strong>est surtout un nombre d'intensité</strong>, <em>comme trente-six chandelles ou cent sept ans.</em>

⛔ <strong>Conséquence : le monde 2 aurait pu former cette expression.</strong> <em>Elle sert le propos et sonne juste, mais elle ne porte pas le dispositif.</em> ✅ <strong>C'est ② qui le porte.</strong>
