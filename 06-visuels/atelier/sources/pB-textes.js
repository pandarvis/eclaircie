...
[`p`,`Le bâtiment était bas et long, en pierre claire, avec une porte battante au milieu. Au-dessus, une planche peinte donnait le nom du lieu et l'heure à laquelle on fermait.`],
...
[`tiret`,`— Mouais.`],
[`tiret`,`— Et je n'ai pas pris d'affaires de rechange. On ne va pas se baigner, lança Andrew en faisant un pas vers la porte.`],
[`p`,`Eliott le regarda et passa devant lui. Il monta la marche du perron et poussa la porte doucement.`],
[`p`,`Dedans, il y avait un guichet sur la gauche et une femme derrière, qui leva la tête en les entendant.`],
[`p`,`Sur le comptoir, une pancarte proposait des montants. Un pour la nourriture d'une semaine, un pour l'entretien d'un bassin, un pour les soigneurs. En dessous, une ligne disait que chacun donnait ce qu'il voulait et qu'on entrait de toute façon.`],
[`tiret`,`— Il faut payer ?`],
[`tiret`,`— Non. Mais les poissons ne se nourrissent pas que de bulles, sourit le veilleur en guettant la réaction du garçon.`],
[`p`,`Eliott le regarda sans répondre ; Andrew se demanda s'il en avait déjà vu un autrement que dans une assiette.`],
...
[`p`,`Le couloir tournait tout de suite. La lumière baissait d'un cran à chaque tournant, et le bruit du dehors s'arrêtait quelque part derrière eux. L'air devint frais, avec une odeur qui n'était ni celle du dehors ni celle d'une maison.`],
...
[`p`,`Le couloir s'ouvrit, et il n'y eut plus de mur devant eux.`],
[`p`,`Le bassin faisait toute la hauteur de la salle. Il fallait lever la tête pour en trouver le haut, et le bas descendait plus bas que le sol où ils se tenaient. La lumière y tombait du dessus et se défaisait en descendant, jusqu'à ne plus rien éclairer, tout en bas.`],
[`p`,`Eliott s'arrêta au milieu de la salle. Ce qu'il avait sur le visage en entrant n'y était plus. Sa bouche s'était ouverte un peu, et son regard passait d'un bout à l'autre de la vitre sans arriver à se poser.`],
...
[`p`,`Eliott s'approcha jusqu'à toucher la vitre du front.`],
[`p`,`Un poisson passa devant lui. Il le suivit des yeux jusqu'à ce qu'il disparaisse, puis attendit son retour.`],
[`p`,`Ils étaient une dizaine dans la salle, debout, chacun devant son morceau de vitre. On distinguait à peine les visages. On avait fait le noir pour les poissons, et les voix avaient baissé avec la lumière.`],
[`p`,`La salle suivante était plus basse. Des bassins de la taille d'une fenêtre s'alignaient des deux côtés, et il fallait s'arrêter devant chacun pour voir tout ce qu'il contenait.`],
[`p`,`Dans le premier, tout vivait ensemble. Un corail blanc tenait le fond. Une anémone se refermait à moitié sur des poissons orange barrés de blanc qui entraient et ressortaient sans en avoir l'air gêné. Au-dessus, une dizaine de petits jaunes vifs repartaient tous ensemble dès qu'on approchait et revenaient dès qu'on s'arrêtait de bouger. Un rond et plat, large comme un plateau, se tenait de profil au milieu de tout ça sans avancer, et son œil suivait les gens.`],
[`p`,`Il y avait plus de couleurs dans cette boîte d'eau que dans toute la rue qu'ils venaient de descendre.`],
[`p`,`Plus loin, un bassin profond, avec des rochers empilés et un creux dessous.`],
[`p`,`La pieuvre en sortit pendant qu'ils étaient là. Un bras d'abord, qui se déroula le long d'une pierre et se colla dessus par en dessous. Un autre suivit. Puis tous les autres à la fois, et elle traversa le bassin sans se presser, en tenant tout ce qu'elle touchait.`],
...
[`p`,`Il resta là, à changer d'appui d'un pied sur l'autre.`],
[`p`,`Au bout d'un moment, il se mit à fredonner. Quelque chose de court, qui revenait sur lui-même et qui n'allait nulle part.`],
[`p`,`Andrew l'écouta quelques secondes.`],
[`tiret`,`— C'est quoi ?`],
[`tiret`,`— Quoi ?`],
[`tiret`,`— Ce que tu chantes.`],
[`p`,`Eliott s'arrêta net.`],
[`p`,`Il chercha.`],
[`p`,`Andrew le vit faire. Pas longtemps. Le garçon semblait savoir qu'il cherchait quelque chose, mais pas quoi.`],
[`tiret`,`— Je sais pas.`],
[`p`,`Il haussa les épaules.`],
[`p`,`Ils repartirent.`],
[`p`,`Deux bassins plus loin, Eliott recommença.`],
[`p`,`Dans la salle d'après, quelque chose bougeait entre des herbes qui montaient du fond en se tenant droites, et qu'on ne voyait jamais en entier.`],
...
[`p`,`La salle d'après ne contenait que des méduses.`],
[`p`,`Elles étaient dans des colonnes d'eau éclairées par en dessous. Elles montaient en s'ouvrant, retombaient en se refermant, et ne se rendaient nulle part. On voyait à travers elles. Les plus petites n'étaient pas plus grosses qu'un ongle et il fallait s'approcher à les toucher pour les trouver.`],
[`p`,`Eliott en suivit une du regard pendant toute sa montée.`],
[`tiret`,`— Ça vit longtemps, ces trucs ?`],
[`p`,`Andrew se pencha vers la plaque.`],
[`tiret`,`— Celles-là, ça dépend. Quand elles sont abîmées, elles redeviennent petites et ça repart.`],
[`tiret`,`— Ah.`],
[`p`,`Ils passèrent à la salle suivante.`],
[`p`,`La dernière salle n'avait pas de plafond. L'eau passait au-dessus d'eux et redescendait des deux côtés, et on marchait dessous.`],
...
[`p`,`Puis une raie traversa tout le plafond, d'un bord à l'autre, si large qu'elle les mit à l'ombre en passant. Elle battait des ailes une fois, très lentement, et cela suffisait pour longtemps. Personne ne parla pendant qu'elle était au-dessus d'eux.`],
...
[`tiret`,`— Rien.`],
[`p`,`Ils firent quelques pas sous l'eau.`],
[`p`,`Un banc de petits poissons vira au-dessus d'eux, d'un seul bloc. Leur ombre passa sur le sol.`],
