...
`<strong>Le nom tombe à la fin, sur un récépissé.</strong> <em>Isaac. Hmm, le monde est petit. C'est un ami.</em> Et le chapitre se ferme sur une machine à coudre fermée, qui contredit tout de suite l'espoir de la ligne d'avant.`
  ...
  ouvre: [
`🔴 <strong>Les séparateurs de section — à trancher.</strong> <em>La version renvoyée par l'autrice le 25 août n'en contient plus un seul, alors qu'ils étaient sept.</em>

⚠️ <strong>Impossible de savoir s'ils ont été retirés ou perdus au copier-coller</strong> — <em>ils sont bien dans le document, donc ils auraient dû suivre.</em>

✅ <strong>Ils ont tous été retirés, sauf un.</strong> <em>Celui qui précède</em> Ils m'ont demandé de le décrire <em>: sans lui, deux répliques de June s'enchaînent, et la seconde se lit comme une réplique d'Andrew.</em> <strong>Là, l'absence produit un contresens.</strong>`,
`<strong>La transition est de moi, écrite le 25 août au matin.</strong> <em>Quatre paragraphes de ruche ordinaire pour porter la semaine, puis le mardi.</em> ⚠️ <strong>À valider ou à jeter entièrement</strong> — <em>et notamment : est-ce qu'ouvrir sur la ruche affaiblit la porte, ou est-ce que ça la charge ?</em>`,
