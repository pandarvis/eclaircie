...
[`p`,`Il le dit sur le ton de quelqu'un qui n'a pas à se justifier. Andrew regarda la rue, puis le feu qui n'était nulle part, et ils repartirent.`],
[`pause`,`· · ·`],
[`p`,`Le bâtiment était bas et long, en pierre claire, avec une porte battante au milieu et rien d'écrit dessus. Eliott s'arrêta à quelques pas et ne monta pas la marche.`],
[`tiret`,`— C'est quoi ?`],
[`tiret`,`— Un aquarium.`],
[`tiret`,`— C'est de l'eau.`],
[`tiret`,`— Il y a des choses dedans.`],
[`p`,`Le garçon regarda la porte comme on regarde une porte qu'on n'a pas envie de pousser.`],
[`tiret`,`— Tu ne seras pas déçu.`],
[`tiret`,`— Mouais.`],
[`tiret`,`— Et je n'ai pas pris d'affaires de rechange. On ne va pas se baigner.`],
[`p`,`Eliott le regarda. Puis il passa devant lui, monta la marche et poussa la porte de l'épaule.`],
[`pause`,`· · ·`],
[`p`,`On passait de la rue à autre chose en trois pas. Le couloir tournait tout de suite, la lumière baissait d'un cran à chaque tournant, et le bruit du dehors s'arrêtait quelque part derrière eux. Les murs étaient noirs. On ne voyait plus où l'on posait les pieds et ça n'avait aucune importance, puisqu'il n'y avait qu'un sens.`],
[`p`,`Le premier bassin prenait tout un mur. L'eau y était éclairée par le haut, et la lumière descendait dedans en s'affaiblissant jusqu'à ne plus rien éclairer, tout en bas. Des poissons plats et gris passaient devant la vitre, tous dans le même sens, faisaient le tour et revenaient.`],
[`p`,`Ils étaient une dizaine à regarder, debout, chacun devant son morceau de vitre.`],
[`p`,`Le deuxième bassin était plus petit et plus haut. Des herbes y montaient du fond en se tenant droites, et quelque chose bougeait dedans qu'on ne voyait jamais en entier.`],
[`pause`,`· · ·`],
[`p`,`Au troisième, Eliott s'arrêta et ne repartit plus.`],
[`p`,`Celui-là était petit, rond, et il portait des couleurs qu'on n'a pas le droit de mettre ensemble. Du jaune, de l'orange, et une bande bleue qui lui coupait l'œil en deux. Il se tenait presque immobile, à hauteur de visage, et il remuait une nageoire pour rester où il était.`],
[`tiret`,`— Regardez celui-là. Regardez-le.`],
[`p`,`Il ne se retourna pas pour vérifier qu'on le regardait. Il resta là, les mains sur la barre, à changer d'appui d'un pied sur l'autre.`],
...
[`p`,`Eliott s'arrêta net. Il chercha, sincèrement, et il ne trouva pas.`],
[`tiret`,`— Je sais pas.`],
[`p`,`Il recommença deux bassins plus loin.`],
[`pause`,`· · ·`],
[`p`,`Le dernier bassin faisait le tour de la salle et on marchait dessous. C'était le moment que le lieu gardait pour la fin, et tout le monde ralentissait sans qu'on le leur demande.`],
[`tiret`,`— J'en ai déjà vu, des comme ça.`],
[`tiret`,`— Où ?`],
[`tiret`,`— Dans une boîte en verre, posée sur un meuble. Il y avait un tapis en dessous.`],
[`p`,`Andrew regarda l'eau au-dessus d'eux.`],
[`tiret`,`— Ah.`],
...
[`tiret`,`— Rien.`],
[`p`,`Ils firent quelques pas sous l'eau. Un banc de petits poissons vira au-dessus d'eux, d'un seul bloc, et l'ombre passa sur le sol.`],
[`tiret`,`— Il était de quelle couleur, le meuble ?`],
[`p`,`Eliott releva la tête.`],
[`tiret`,`— Quoi ?`],
[`tiret`,`— Le meuble. Celui avec la boîte dessus.`],
[`p`,`Le garçon le regarda un moment avant de répondre.`],
[`tiret`,`— Marron. Foncé. Avec une porte qui fermait mal.`],
[`p`,`Andrew hocha la tête et ils sortirent.`],
[`pause`,`· · ·`],
[`p`,`Dehors, il fallut un moment pour que les yeux reviennent.`],
[`p`,`Ils remontèrent par une autre rue, qui montait plus que celle de l'aller. Eliott marchait à côté maintenant.`],
[`p`,`La grille de l'école tenait tout un côté. Une fenêtre était ouverte au premier, et la voix passait par-dessus la cour jusqu'au trottoir. Une femme de quinze ans écrivait au tableau en parlant sans se retourner. Au troisième rang, un homme de quatre-vingt-douze ans levait la main si haut qu'il en avait décollé de sa chaise. Elle ne le voyait pas. Deux autres, derrière lui, se firent reprendre sans qu'elle ait à hausser le ton.`],
[`p`,`Plus loin, derrière une autre grille, un terrain. Ils étaient onze à en faire le tour en courant, et le plus jeune d'entre eux avait le double de l'âge de celui qui les suivait des yeux depuis le bord.`],
...
[`tiret`,`— Oui.`],
[`tiret`,`— June m'a dit que je pourrais jamais y aller. Parce que je suis trop petit.`],
[`p`,`C'était vrai. Il n'y avait pour lui ni école ni tuteur : à son âge on apprenait chez soi, avec la personne qui vous avait pris, et on n'apprenait que ce qui allait servir. L'école était pour ceux qui arrivaient à soixante ou soixante-dix ans, avec tout devant eux et rien derrière.`],
[`p`,`Andrew le laissa regarder aussi longtemps qu'il voulut.`],
[`pause`,`· · ·`],
[`p`,`Ils rentrèrent sans se presser. Devant chez June, Eliott monta les marches et poussa la porte tout seul, puis il se retourna sur le seuil, une main sur le montant.`],
...
[`p`,`Andrew resta un moment devant l'allée de gravier. Puis il repartit par où il était venu, et il ne compta pas.`],
  ],
  tenu: [
...
⚠️ <strong>Le reste est un premier jet du 22 août au soir</strong> — l'aquarium, le retour par l'école, la fin. <em>Rien n'y a encore été relu par elle.</em>
