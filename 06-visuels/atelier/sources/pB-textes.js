...
[`p`,`Ils descendirent la rue ensemble. Eliott marchait un demi-pas devant.`],
[`p`,`Au carrefour, il quitta le trottoir sans regarder. Andrew le rattrapa par le col et le remit sur le bord. Une voiture passa, sans vitesse, et le conducteur ne tourna même pas la tête.`],
[`tiret`,`— Normalement, ils me laissaient passer, ici.`],
[`p`,`Il le dit sur le ton de quelqu'un qui n'avait pas à se justifier.`],
[`p`,`Andrew regarda la rue, puis l'endroit où aurait dû se trouver un feu. Il n'y avait rien. Pas de feu, pas de passage protégé, pas même un panneau. Seulement la route et les voitures.`],
[`p`,`Il regarda Eliott une seconde de plus.`],
[`p`,`Le garçon avait déjà repris sa marche.`],
[`p`,`Andrew le suivit.`],
...
[`p`,`Le couloir tournait tout de suite. La lumière baissait d'un cran à chaque tournant, et le bruit du dehors s'arrêtait quelque part derrière eux.`],
...
[`p`,`Le premier bassin prenait tout un mur.`],
[`p`,`L'eau y était éclairée par le haut, et la lumière descendait dedans en s'affaiblissant jusqu'à ne plus rien éclairer, tout en bas.`],
[`p`,`Eliott ralentit.`],
[`p`,`Des poissons plats et gris passaient devant la vitre, tous dans le même sens. Ils faisaient le tour et revenaient.`],
[`p`,`Il s'approcha jusqu'à presque toucher la vitre du front.`],
[`p`,`Un poisson passa devant lui.`],
[`p`,`Il suivit son mouvement des yeux jusqu'à ce qu'il disparaisse dans le noir, puis attendit son retour.`],
[`p`,`Ils étaient une dizaine à regarder, debout, chacun devant son morceau de vitre. Personne ne parlait beaucoup.`],
[`p`,`Le deuxième bassin était plus petit et plus haut. Des herbes montaient du fond en se tenant droites, et quelque chose bougeait dedans qu'on ne voyait jamais en entier.`],
[`p`,`Eliott resta là un moment.`],
[`p`,`Il se penchait d'un côté, puis de l'autre, essayant de suivre ce qui se cachait entre les herbes.`],
[`tiret`,`— Il est où ?`],
[`tiret`,`— Quoi ?`],
[`tiret`,`— Le truc.`],
...
[`p`,`Au troisième, il s'arrêta et ne repartit plus.`],
...
[`p`,`Le dernier bassin faisait le tour de la salle et on marchait dessous.`],
[`p`,`C'était le moment que le lieu gardait pour la fin. Tout le monde ralentissait sans qu'on le leur demande.`],
[`p`,`Au-dessus d'eux, l'eau formait un plafond mouvant. Des poissons passaient dans la lumière, disparaissaient, puis revenaient ailleurs.`],
[`p`,`Eliott leva la tête.`],
