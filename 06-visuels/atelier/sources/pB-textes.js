...
[`p`,`Elle referma l'armoire, et elle la rouvrit aussitôt.`],
[`tiret`,`— Si. Il manque son poisson.`],
[`tiret`,`— Son poisson ?`],
[`tiret`,`— Une peluche. Bleu et orange, avec les nageoires striées.`],
[`p`,`Elle écarta les piles de linge une par une.`],
[`tiret`,`— Il l'a depuis deux ou trois semaines. Il ne me l'a jamais montrée, je l'ai vue en faisant le lit. Elle est toujours sur l'oreiller ou dessous.`],
[`tiret`,`— Avec une petite vague brodée sur la nageoire de gauche ?`],
[`p`,`June arrêta ce qu'elle faisait.`],
[`tiret`,`— Avec une petite vague brodée sur la nageoire de gauche. Comment vous savez ça ?`],
[`p`,`Il ne répondit pas tout de suite.`],
[`p`,`Il y avait une boutique à côté de l'aquarium, une petite, avec deux paniers dehors et le reste en vitrine. Ils étaient passés devant en sortant. Le garçon s'était arrêté, avait regardé, et n'avait rien demandé.`],
[`tiret`,`— Je l'ai vue quelque part.`],
[`p`,`Le policier avait soulevé l'oreiller.`],
[`tiret`,`— C'est ça ?`],
[`p`,`La peluche était dessous, couchée sur le drap, tête vers le mur.`],
[`p`,`June la prit, la regarda, et la reposa exactement comme elle l'avait trouvée.`],
[`tiret`,`— Oui.`],
[`pause`,`· · ·`],
...
[`tiret`,`— Il est ici depuis un mois. Il connaît ce quartier et il ne connaît que celui-là. Sa tournée fait trois rues, il rentre par le haut, il n'est jamais allé plus loin que la place. Elle a fait le tour deux fois et personne ne l'a vu.`],
[`p`,`Il regarda l'escalier.`],
[`tiret`,`— Et il a laissé la seule chose qu'il ait jamais voulue.`],
...
`<strong>June ne reproche rien à Andrew.</strong> ⚠️ <em>C'est lui qui a demandé qu'on revienne : elle ne peut pas lui reprocher de n'avoir pas posé la question.</em> ✅ <strong>Le reproche, léger, s'adresse à l'enquête :</strong> <em>on ne m'a pas demandé à quoi il ressemblait en rentrant.</em>`
  ...
  ouvre: [
`🔴 <strong>La peluche : trouvée, et non manquante.</strong> ⚠️ <em>La note du 25 août disait qu'il manque quelque chose.</em> <strong>Mais si elle manque, il l'a emportée</strong> — <em>et la fugue s'en trouve renforcée, l'inverse de ce que le chapitre doit produire.</em>

✅ <strong>Elle est donc cherchée puis trouvée sous l'oreiller</strong>, <em>ce qui garde le dialogue de description entier et retourne l'argument.</em> ❓ <strong>À confirmer.</strong>`,
`❓ <strong>Le second argument contre la fugue.</strong> <em>La peluche seule ne suffit pas : il est parti travailler, il n'avait aucune raison d'emporter quoi que ce soit.</em> ✅ <strong>D'où le quartier</strong> — <em>un arrivant d'un mois ne connaît que trois rues, et Julie a fait le tour deux fois.</em> ❓ <em>Est-ce assez pour qu'un policier l'entende ?</em>`,
