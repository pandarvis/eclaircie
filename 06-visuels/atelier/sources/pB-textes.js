...
[`p`,`Il avait le visage des mauvais jours. Andrew le suivit sans rien demander.`],
...
[`p`,`Il connaissait les boîtes. Il savait laquelle s'ouvrait mal, laquelle prenait les gros et laquelle il fallait pousser par en dessous. Devant l'une d'elles il se mit sur la pointe des pieds ; devant une autre il s'accroupit.`],
...
[`p`,`Au bout de la troisième rue, il fallut sonner et attendre. Un homme ouvrit, prit son paquet, signa dans le carnet et referma. Eliott rangea le carnet sans regarder ce qui était écrit dessus.`],
[`tiret`,`— C'est lourd ?`],
[`tiret`,`— Non.`],
[`p`,`C'était lourd.`],
[`p`,`Ils remontaient vers la place quand le garçon s'arrêta net, mit deux doigts dans sa bouche et siffla.`],
...
[`p`,`Le garçon parlait plus, maintenant, et il parlait de travers.`],
[`p`,`Devant l'épicerie du bas, il ralentit.`],
[`tiret`,`— Mais si, il y avait un magasin de chaussures ici, pas une épicerie.`],
[`p`,`Andrew regarda la vitrine. Des cageots sur le trottoir, un panneau écrit à la craie, une femme qui rentrait des caisses vides.`],
[`tiret`,`— Ah.`],
[`tiret`,`— Je te dis.`],
[`p`,`Il en dit deux ou trois autres du même genre avant la fin de la tournée. Andrew les laissa passer comme les premières.`],
...
[`p`,`June resta sur le seuil, la main sur le montant.`],
[`tiret`,`— Il a été comme ça toute la journée ?`],
[`tiret`,`— Toute la semaine.`],
[`p`,`Elle regarda le bout de la rue.`],
[`tiret`,`— Je lui demande ce qu'il a, il me dit rien. Je lui demande si ça va au travail, il me dit oui. Je sais qu'il ment et je ne sais pas quoi en faire.`],
[`p`,`Elle changea de main sur le montant.`],
[`tiret`,`— Il a fini par me dire une chose, hier soir.`],
[`p`,`Elle attendit un peu.`],
[`tiret`,`— Que les autres, là-bas, le traitaient de porteur de voiles.`],
[`p`,`Elle le dit plus bas, comme on rapporte un mot qu'on ne dirait pas soi-même. Puis elle passa à autre chose.`],
[`tiret`,`— Bon. Il faut que je m'occupe du repas.`],
[`tiret`,`— Oui.`],
[`p`,`Elle referma.`],
[`p`,`Andrew resta un moment devant l'allée. En haut, la fenêtre du garçon était fermée.`],
...
`<strong>Ce qu'Eliott dit d'autre pendant la tournée.</strong> <em>Deux ou trois choses du même genre, résumées en une ligne pour noyer l'épicerie sans la doubler. Faut-il en entendre une seconde ?</em>`
  ...
  note: `⚠️ <strong>Premier jet du 23 août 2026.</strong> <em>Rien n'y a encore été relu par l'autrice.</em>
