...
[`tiret`,`— Fermé. Il ne demande rien et il ne refuse rien.`],
[`p`,`Elle chercha un exemple et le trouva.`],
[`tiret`,`— Le soir, on sort les jeux. Paul adorait ça, Julie joue pour lui faire plaisir. Lui, il regarde. Si on l'appelle il vient, il joue, il gagne ou il perd, et à la fin il remonte. Il n'a jamais demandé à jouer une fois de plus.`],
[`tiret`,`— Et avec vous, Julie ?`],
[`p`,`Julie avait posé son livre sur ses genoux, page contre la cuisse.`],
...
[`tiret`,`— Mais c'est moi qui parle. Lui, il écoute.`],
...
[`p`,`Le lieutenant reprit son crayon.`],
[`tiret`,`— La piscine ?`],
...
[`tiret`,`— Contre personne. On me l'a rapporté le soir même. Il ne voulait pas entrer dans le bassin, on a insisté, et il a…`],
[`p`,`Elle s'arrêta là et ne reprit pas la phrase.`],
[`tiret`,`— Ils l'ont fait sortir. Il n'y retournera pas.`],
[`tiret`,`— Pourquoi il n'y retournera pas ?`],
...
[`tiret`,`— Il est monté sans rien dire. Je suis allée le voir, il m'a envoyée promener. Julie a essayé, Paul a essayé. Il a refusé de descendre manger.`],
[`p`,`Elle passa le pouce sur le bord de la table.`],
[`tiret`,`— Je lui ai monté une assiette et je l'ai laissée devant sa porte. Quand je suis montée me coucher, deux heures après, elle y était encore. Je l'ai redescendue.`],
[`tiret`,`— Et le lendemain ?`],
[`tiret`,`— Le lendemain il était comme avant. Il a dit bonjour, il a mangé, il est parti travailler.`],
[`p`,`Elle laissa passer un temps.`],
[`tiret`,`— Comme si ça n'avait pas eu lieu.`],
[`tiret`,`— C'était quand ?`],
[`tiret`,`— La semaine dernière. Je ne sais plus quel jour.`],
[`p`,`Le policier écrivit trois lignes, releva la tête et regarda l'escalier.`],
[`tiret`,`— On peut voir sa chambre ?`],
[`tiret`,`— Montez.`],
[`pause`,`· · ·`],
[`p`,`L'escalier fit du bruit sous eux.`],
[`p`,`La chambre était petite et bien tenue. Un lit fait au carré, une table sous la fenêtre, une chaise, une armoire basse. Sur une étagère, une pile de livres d'images posés à plat, et une lampe.`],
[`p`,`Andrew resta près de la porte. Le policier fit le tour, ce qui prit trois pas.`],
...
[`p`,`Le policier ouvrit le tiroir de la table. Les dessins y étaient empilés sur deux ou trois centimètres, traits et ronds au crayon, une feuille par-dessus l'autre. Il les repoussa.`],
[`p`,`Dessous, quatre enveloppes fermées.`],
[`tiret`,`— Ça, c'est quoi ?`],
...
[`p`,`Une masse orange et bleue dépassait de sous l'oreiller.`],
[`tiret`,`— Et ça ?`],
[`p`,`Isaac suivit le regard du veilleur et souleva le coussin.`],
[`tiret`,`— Son poisson, dit June.`],
[`p`,`Elle vint le prendre et le garda contre elle sans s'en apercevoir.`],
[`tiret`,`— Il ne s'en sépare pas. Il lui arrive même de le prendre dans sa sacoche pour aller travailler. Je lui ai dit que ça ne se faisait pas, il l'emmène quand même.`],
[`tiret`,`— Il l'a depuis longtemps ?`],
[`tiret`,`— Trois semaines. C'est moi qui le lui ai acheté.`],
[`p`,`Elle tourna la peluche dans ses mains.`],
[`tiret`,`— Il me l'a demandé. C'est la seule fois où il m'a demandé quelque chose.`],
...
[`tiret`,`— Et toi, il t'a parlé, ces derniers jours ?`],
...
[`p`,`Le policier écrivit deux lignes de plus et souligna quelque chose.`],
...
[`p`,`Il regarda le policier en face.`],
