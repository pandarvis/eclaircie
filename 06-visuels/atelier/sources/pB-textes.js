...
[`p`,`Le cerisier de la quatrième maison après le tournant commençait à perdre. Il en tombait sur le gravier, et personne n'avait balayé.`],
[`p`,`Il sonna.`],
[`p`,`June ouvrit presque aussitôt. Elle avait remis un tablier.`],
[`tiret`,`— Vous êtes deux.`],
[`tiret`,`— Isaac. On s'est vus l'autre soir.`],
[`tiret`,`— Je sais.`],
[`p`,`Elle s'écarta pour les laisser entrer.`],
[`p`,`La table était débarrassée, les volets ouverts. La pièce sentait quelque chose, cette fois. Julie était à sa place, devant sa machine, et elle cousait.`],
...
[`p`,`Elle le lui redonna quand même. Les mêmes heures, les mêmes phrases, à un mot près, comme on récite une chose apprise contre son gré.`],
...
[`tiret`,`— Je l'ai.`],
[`tiret`,`— Alors ?`],
[`tiret`,`— Et lui, il était comment ?`],
[`tiret`,`— Poli.`],
[`p`,`Elle laissa le mot tout seul un instant.`],
[`tiret`,`— Il dit bonjour, il mange, il aide quand on lui demande. Il ne raconte rien. Ça fait un mois qu'il vit ici et je ne saurais pas dire ce qu'il aime.`],
[`tiret`,`— Vous en aviez parlé à quelqu'un ?`],
[`tiret`,`— À lui.`],
[`p`,`Il n'avait rien dit depuis qu'ils étaient entrés.`],
[`tiret`,`— Vous n'avez rien noté d'autre ?`],
[`p`,`June se tourna vers lui.`],
[`tiret`,`— D'autre ?`],
[`tiret`,`— Pas la journée. Les jours d'avant. Quelque chose qui aurait changé.`],
...
[`tiret`,`— Contre personne. On me l'a rapporté le soir même.`],
[`p`,`Elle resserra le nœud de son tablier sans en avoir besoin.`],
[`tiret`,`— Il ne voulait pas entrer dans le bassin. On a insisté, et il a…`],
...
[`tiret`,`— Furieux. Il est monté, il a fermé la porte, et je ne l'ai pas revu jusqu'au lendemain.`],
[`tiret`,`— Et le lendemain ?`],
[`tiret`,`— Le lendemain il était comme avant. Il a débarrassé. Il m'a demandé s'il pouvait sortir.`],
[`p`,`Elle remit droite une chaise qui l'était déjà.`],
[`tiret`,`— Comme si ça n'avait pas eu lieu.`],
[`tiret`,`— C'était quand ?`],
[`tiret`,`— La semaine dernière. Je ne sais plus quel jour.`],
[`p`,`Elle attendit qu'Isaac ait fini d'écrire.`],
[`tiret`,`— Vous ne m'aviez pas posé la question, Andrew.`],
[`p`,`Elle ne le dit pas méchamment. Elle le dit comme on constate une chose qu'on vient de comprendre en la disant.`],
[`tiret`,`— Non.`],
...
[`p`,`Rien aux murs.`],
[`p`,`Andrew resta près de la porte. Isaac fit le tour, ce qui prit trois pas.`],
[`tiret`,`— Il n'a rien mis aux murs ?`],
[`tiret`,`— Je lui ai proposé. Il a dit que ça allait comme ça.`],
[`p`,`Isaac ouvrit l'armoire, regarda dedans et la laissa ouverte.`],
[`tiret`,`— Il manque quelque chose ?`],
[`p`,`June vint voir avec lui.`],
[`tiret`,`— Non.`],
[`tiret`,`— Vous êtes sûre ?`],
[`tiret`,`— Il avait trois chemises. Elles sont trois.`],
[`p`,`Elle referma l'armoire elle-même.`],
[`p`,`Sur la table, un cahier fermé, un crayon posé bien droit dessus.`],
[`tiret`,`— Il écrit ?`],
[`tiret`,`— Il apprend. Il en est aux lettres.`],
[`p`,`Isaac ouvrit le cahier, tourna deux pages et le referma.`],
[`p`,`Andrew ne s'approcha pas de la table. Il regarda par la fenêtre. On voyait le haut de la rue, celle qu'il prenait tous les matins.`],
[`p`,`Ils redescendirent. Julie posa son ouvrage quand ils s'assirent.`],
...
[`tiret`,`— Vous étiez trois dans la maison, dit Isaac.`],
[`tiret`,`— Paul. Il est parti au jardin vendredi.`],
[`p`,`Isaac garda le crayon en l'air.`],
[`tiret`,`— Il faudrait peut-être…`],
[`tiret`,`— Il ne saura rien de plus que moi.`],
[`p`,`Julie l'avait dit sans lever la tête, et elle repiqua l'aiguille.`],
[`tiret`,`— Vous nous avez signalé une altercation à son travail.`],
[`tiret`,`— Oui.`],
[`tiret`,`— Vous en savez quoi, exactement ?`],
[`p`,`June tira une chaise et s'assit avec eux.`],
[`tiret`,`— Il est rentré la veille avec les genoux en sang et la lèvre fendue.`],
[`p`,`Julie s'était arrêtée de coudre.`],
[`p`,`Le veilleur se redressa sur sa chaise.`],
[`tiret`,`— La veille de sa disparition ?`],
[`tiret`,`— La veille.`],
[`tiret`,`— Et vous ne l'avez pas dit.`],
[`tiret`,`— Je l'ai dit. J'ai dit qu'il y avait eu une altercation.`],
[`p`,`Isaac écrivait sans relever la tête.`],
[`tiret`,`— Il vous a expliqué ?`],
[`tiret`,`— Il a dit qu'il était tombé.`],
[`tiret`,`— Vous l'avez cru ?`],
[`p`,`June mit longtemps à répondre.`],
[`tiret`,`— Non.`],
[`p`,`Isaac releva la tête.`],
[`tiret`,`— Ce n'est pas dans le procès-verbal, dit Andrew.`],
[`tiret`,`— Non.`],
[`tiret`,`— Pourquoi ?`],
[`tiret`,`— Parce que je ne l'ai pas demandé.`],
[`p`,`Il le dit sans se défendre, écrivit encore deux lignes et referma le carnet.`],
[`tiret`,`— On va voir son responsable.`],
[`p`,`June les accompagna jusqu'à la porte et resta sur le seuil, une main sur le montant, jusqu'à ce qu'ils aient passé le portillon.`],
[`p`,`Andrew ne se retourna pas.`],
...
[`p`,`Un homme fumait devant l'entrée. Il les regarda descendre la rue, jeta ce qui lui restait et rentra sans attendre qu'ils arrivent.`],

  ],
  tenu: [
`<strong>Le nom d'Andrew ne revient pas par le narrateur, il revient par une bouche.</strong> <em>Vous ne m'aviez pas posé la question, Andrew</em> — <strong>et il arrive dans un reproche, à mi-chapitre, après quarante paragraphes sans lui.</strong>`,
`<strong>La maison a repris.</strong> <em>La table est débarrassée, les volets ouverts, la pièce sent quelque chose — et Julie coud.</em> <strong>Trois échos du chapitre précédent, où rien de tout cela n'était vrai.</strong>`,
`<strong>Isaac n'est jamais décrit.</strong> <em>Il sort un carnet, il écrit, il relève la tête.</em> 🔴 <strong>Ce sont exactement les gestes du chapitre du poste</strong> — <em>et c'est le visage de là-bas que le lecteur lui prête.</em>`,
`<strong>La colère ne s'explique pas.</strong> <em>June la rapporte, s'arrête au milieu d'une phrase et ne la reprend pas.</em> ⛔ <strong>Personne ne dit ce qui l'a déclenchée, personne ne prononce le mot eau.</strong>`,
`<strong>Le non-savoir de Julie est actif.</strong> <em>Elle prend le temps de réfléchir vraiment, et cela dure plus longtemps que sa réponse.</em> <strong>Elle répond à tout, et rien ne sert.</strong>`,
`<strong>Paul est écarté par Julie, pas par les enquêteurs.</strong> <em>Il ne saura rien de plus que moi</em> — <strong>dit sans lever la tête, et elle repique l'aiguille.</strong> <em>C'est sa dernière réplique du livre.</em>`,
`<strong>Isaac ne se défend pas.</strong> <em>Ce n'est pas dans le procès-verbal. — Non. — Pourquoi ? — Parce que je ne l'ai pas demandé.</em> <strong>Le chapitre entier tenait sur ce vide, et il l'admet en six mots.</strong>`,
`<strong>Aucun geste n'est séparé de sa réplique</strong> — <em>règle dégagée le 25 août sur le chapitre du poste.</em> <strong>Et deux répliques d'un même personnage ne sont jamais coupées par une narration.</strong>`
  ],
  ouvre: [
`🔴 <strong>Le rythme d'apparition du nom.</strong> <em>Andrew arrive au paragraphe 46, par June ; le veilleur au paragraphe 88, par le narrateur.</em> ❓ <strong>Est-ce assez tard, ou pas assez ?</strong> <em>Trop tôt, le contraste avec le chapitre du poste se voit ; trop tard, le lecteur se demande à qui il a affaire.</em>`,
`❓ <strong>La chambre est-elle assez vide ?</strong> <em>Rien aux murs, trois chemises, une armoire qu'elle referme elle-même.</em> <strong>Rien n'a disparu, et c'est ce qui doit faire mal.</strong> ❓ <em>Faut-il un objet, un seul, qui reste sans explication ?</em>`,
`❓ <strong>Le hook du dépôt.</strong> <em>Un homme qui jette sa cigarette et rentre sans attendre qu'ils arrivent.</em> ⚠️ <strong>C'est peut-être déjà trop dire</strong> — <em>on n'est pas censé soupçonner qui que ce soit à ce stade.</em> ❓ <strong>À garder, à adoucir, ou à couper net sur le seuil de June.</strong>`,
`✅ <strong>Deux trous de logique trouvés à la relecture et bouchés.</strong>

<em>Julie disait</em> comme les autres jours <em>alors qu'elle avait forcément vu la lèvre fendue.</em> ✅ <strong>Elle répondait à la question posée</strong> — <em>on lui demandait son comportement, pas son apparence</em> — <strong>et quand June lâche les blessures, elle s'arrête de coudre.</strong> <em>Sans un mot.</em>

<em>Le veilleur reposait un verre que personne ne lui avait servi : il venait du chapitre précédent.</em> ✅ <em>Remplacé par un mouvement sur la chaise.</em>`
  ],
  note: `⚠️ <strong>Premier jet du 25 août 2026, écrit pendant l'absence de l'autrice.</strong> <em>À relire entièrement.</em>

<strong>Deux points du dossier ont été corrigés en chemin.</strong> <em>La fiche du 22 août disait qu'Eliott avait refusé le cours de natation ; la version du 25 est qu'il en a été exclu pour une colère, ce qui est plus fort — c'est un fait rapporté à June, pas un refus qu'elle a vu.</em> <em>Et le cours de natation n'est pas une activité du soir : les cours du soir vont aux arrivants de soixante-dix à cinquante ans. À son âge, c'est la berceuse qui fait tout, sauf ce qu'elle ne peut pas donner elle-même.</em> ✅ <strong>Ce qui sert mieux : elle l'a envoyé là-bas, et elle n'y était pas.</strong>

⚠️ <strong>Ce que je sais déjà de discutable :</strong> <em>June parle beaucoup, encore une fois</em> ; <em>la scène de la chambre est courte et pourrait ne rien valoir</em> ; <em>et le dernier paragraphe fabrique une suspicion que rien ne justifie.</em>`
},
