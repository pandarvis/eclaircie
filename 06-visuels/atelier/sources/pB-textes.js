...
[`p`,`Il y eut d'autres fois. À force de se voir, quelque chose changea entre eux sans qu'aucun des deux ne s'en aperçoive vraiment. Un matin, Eliott lui dit bonjour sans le vouvoyer.`],
[`p`,`Andrew ne releva pas.`],
[`p`,`Ce ne fut que deux jours plus tard, en y repensant, qu'il comprit.`],
...
[`p`,`Andrew avait relevé assez d'âges pour savoir ce que cela valait.`],
[`p`,`Chez les grands nombres, la descente se tenait : régulière, prévisible d'une année sur l'autre. Il n'y avait qu'à laisser faire.`],
...
[`p`,`Il parlait un peu plus, maintenant.`],
[`p`,`De tout.`],
...
[`p`,`Eliott s'arrêta net.`],
[`p`,`Il porta deux doigts à sa bouche et siffla.`],
...
[`tiret`,`— Salut.`],
[`p`,`La porte s'ouvrit et il entra sans attendre.`],
[`p`,`On l'entendit monter l'escalier. Une porte se ferma à l'étage.`],
[`p`,`June resta sur le seuil, une main sur le montant.`],
[`p`,`Elle regardait le haut de l'escalier.`],
...
[`p`,`Elle ne disait pas cela comme un reproche.`],
[`p`,`Plutôt comme un constat qui lui faisait mal.`],
...
[`p`,`Ça n'expliquait pas le premier jour.`],
[`p`,`Ni ce qu'il avait vu à la table.`],
[`p`,`Ni cette manière qu'avait le garçon d'imiter certains gestes sans savoir pourquoi.`],
...
[`p`,`Puis elle rentra chez elle.`],
[`p`,`La porte se referma doucement derrière elle.`],
