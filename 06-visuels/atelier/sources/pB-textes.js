...
[`tiret`,`— Rien du tout ?`],
[`tiret`,`— Des horaires.`],
[`p`,`Il retourna le feuillet pour vérifier ce qui était écrit au dos, puis le remit en place.`],
...
[`tiret`,`— Merci.`],
[`p`,`Il se pencha sur la carte et posa un doigt sur le secteur.`],
[`tiret`,`— Là.`],
[`p`,`Il suivit une rue du bout de l'ongle.`],
[`tiret`,`— Ce quartier, tu vois ? Il m'est arrivé de passer devant. J'ai déjà entendu des disputes.`],
