...
{ id:`eliott`, nom:`Eliott`, voie:`andrew`, role:`L'arrivant de dix ans. Le second et dernier porteur de voiles du livre.`,
  ...
  portrait:[`**Donné par l'autrice le 22 août 2026, et transposé.** *Son texte disait <em>l'enfance</em>, <em>les enfants de son âge</em>, <em>un adolescent</em>, <em>en grandissant</em> — quatre mots que cette langue n'a pas.*`,
    `**Le visage doux, encore rond aux joues.** *Un nez court et droit, une bouche fine. Des cheveux bruns, épais, coupés par quelqu'un qui savait le faire et qui repartent en mèches sur le front et les oreilles.* **Ce qui tient le visage, ce sont les yeux : verts, larges, et ils prennent toute la place.** *Décision de l'autrice, 22 août 2026.*`,
...
**Conséquence sur ses adieux :** *tu vas être bien là-dedans, mieux qu'avec moi* cesse d'être ce qu'on dit à un mourant. **C'est quelqu'un qui sait que l'endroit est bien, puisqu'elle y sera.** — *Et c'est Andrew qui répond à sa place, une fois qu'elle est partie : « t'inquiète pas, elle viendra te voir, tu la connais ».*`,
  portrait:[`**Donné par l'autrice le 22 août 2026, et repris par elle.** *Elle a pris soin de tirer ses cheveux blonds en arrière et de les nouer bas, sans que cela la durcisse. Grande, fine, vêtue de presque rien qui se remarque, avec par-dessus un tablier qui a déjà servi ce matin-là.* **Vingt-deux ans, à peu près.**`,
