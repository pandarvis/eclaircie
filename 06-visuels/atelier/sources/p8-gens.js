...
{ id:`paul-julie`, nom:`Paul et Julie`, voie:`andrew`, role:`Les deux autres arrivants de chez June.`,
  ...
  clef:`⚠️ **Son âge doit être sur la page avant ses onze ans de couture.** *Repérage de l'autrice, 23 août 2026 : sans lui, le paradoxe passe inaperçu.* **« Elle avait l'âge d'Eliott, ou à peu près »**, dit à sa première apparition — *et le prologue a déjà donné le chiffre : l'Archiviste lui a compté dix ans.*
