...
{ id:`paul-julie`, nom:`Paul et Julie`, voie:`andrew`, role:`Les deux autres arrivants de chez June.`,
  ...
  clef:`**Julie ou Paul est celui ou celle qu'Eliott siffle dans la rue, à la tournée.** *— Tu vas où ? — June m'a demandé de récupérer du lait !* **Deux répliques, et on repart.** *C'est par elles que la maisonnée entre dans le livre, sans une phrase d'exposition.*`,
  gardes:[`**Ils sont des témoins, et l'enquête doit les voir.** *On n'interroge pas une maison sans interroger ceux qui y vivent* — **ils reparaissent donc quand Joël et Liam viennent chez June.**`,
  ...
  ouvert:[`⚠️ **Lequel des deux Eliott siffle dans la rue.** *Julie, plutôt — trois garçons d'affilée dans le même chapitre, ça commence à peser.*`,
