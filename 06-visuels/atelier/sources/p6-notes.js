...
🔴 **Ce que la première réserve pour plus tard :** *la paire regarde Andrew et lui parle, et il n'entend pas à cause de l'eau qui coule.* **C'est la place de la seconde cérémonie — celle qui lui rendra ce qu'il croyait ne pas avoir entendu. La phrase reste à écrire, et c'est à l'autrice.**

⛔ **Ce que j'ai osé sans le demander :** *sa première question, un quart d'heure après avoir ouvert les yeux, est de savoir où c'est écrit.* **Le reliquat sort le premier jour, et personne dans la pièce ne peut le voir.** *Ça se coupe en une ligne si c'est trop tôt.*` },
