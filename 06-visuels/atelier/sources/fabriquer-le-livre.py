...
function fermerLivre(){
  ...
  setTimeout(function(){ spread=-1; anime=false; majEtat() },570);
}
...
function ajuster(){
  ...
  const k=Math.min((vw-200)/SW,(vh-128)/PH);
...
$('bGlo').addEventListener('click',function(){
