...
| **Les notes** | 118 notes — tout ce qui s'est dit les 13, 14, 15 et 16 août, dans l'ordre. Tes mots sont cités tels quels, et en dessous ce que la décision a produit. Cherchable, filtrable. |
| **Le monde** | Le lexique, les règles, les onze interdits, le décompte des âges (avec son graphe), le calendrier, le dispositif des deux récits, et les faux raccords. |
...
Les documents de `01-dossier`, `02-univers`, `03-personnages` et `04-plan` restent la référence.
