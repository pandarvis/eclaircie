...
*La liste unique. **Elle a remplacé le glossaire et le lexique**, qui définissaient les mêmes
mots deux fois, chacun dans son coin — quarante-neuf entrées sur cinquante et une étaient en
double, et les deux définitions avaient commencé à diverger.*

**Deux parties, et une seule règle pour les séparer.**

| | Ce qu'elle contient | Qui la lit |
|---|---|---|
| **Le glossaire** | ce que le lecteur peut avoir besoin de chercher | **cette partie EST la page de fin de volume** |
| **La bible** | outils d'autrice, mots morts, et ce que tout le monde sait déjà | l'autrice seule |

> ⚠️ **Ne pas éditer `05-manuscrit/glossaire.md` ni `p7-monde.js` : ils sont générés depuis
> ce fichier.** On corrige ici, puis `python glossaire.py` depuis `06-visuels/atelier/sources/`.
> *La fabrication de l'atelier recalcule la signature de cette page et refuse de tourner si
> la copie a pris du retard.*

**Ce qui sort du glossaire n'est pas supprimé : il descend dans la bible.** *Décision de
l'autrice, 20 août 2026 — un mot que tout le monde comprend déjà n'a rien à faire sur une
page de fin de volume. Un écusson, un numéro, un instrument : personne n'a besoin qu'on
le lui explique.*

**Format d'une entrée.** Le mot en gras, la définition, puis une ligne de citation qui porte
la source et, s'il y en a une, la question non tranchée. *La ligne de citation ne va jamais
sur la page du lecteur.*
...
pas et ne s'annonce pas** — elle vient d'un coup et elle crève. Aucune cérémonie possible ;
on nettoie.
> `02-univers/la-ruche.md`
...
tranche pour tous. **La découverte du visage appartient à la cérémonie :** personne ne
...
à ce qu'il fait. *On ne dit jamais « arrivant voilé » : trop connoté.*
> `02-univers/ce-qui-est-juge.md` · ❓ Où le lecteur apprend-il ce que c'est ? Une seconde occurrence ailleurs ferait du mot une notion, et la gêne disparaîtrait avec.

**Préparateur.** Agent de la serre. Il décroche les capsules, les nettoie, les conduit
jusqu'à la salle de cérémonie, redresse les chariots, remet la fiche au veilleur — puis il
s'arrête à la porte et regarde. **Il exécute et il écoute : la date ne lui appartient pas.**
Il revient à la fin chercher les capsules vides et les bassines.
> `02-univers/la-ruche.md` · ❓ On ne les voit que là, deux fois par cérémonie. Ce qu'ils font le reste du temps n'est pas écrit.
...
jamais rien : il constate.**
> `02-univers/la-ruche.md` · ❓ Il est infaillible, et il le reste. C'est la condition du temps 5.
...
pas savoir que c'est un nom, donc il ne le retient pas, ne le note pas, ne le cherche pas.*
C'est le seul mot du parcours qui puisse revenir cent fois sans jamais rien apprendre.
> `04-plan/deux-histoires-en-une.md §2.5`

**Le bâtiment inachevé.** Ambition que rien ne justifie, commencée par un arrivant qui a
atteint le jardin avant de la finir. **Façon retenue de suggérer les grandes figures
...
**L'écusson.** Emblème de la ruche brodé sur la blouse : une capsule de profil, d'un seul
fil. **Un seul emblème pour tout le complexe, pas une variante par métier** — décision de
l'autrice, 20 août 2026. *Il n'ouvre aucune porte au-dehors et ne donne aucun pouvoir : il
identifie quelqu'un au sein de la ruche, comme le caducée sur une blouse de médecin.* ⛔ Le
...
accident. **Tout le monde arrive ainsi, et peu le restent.**
> `02-univers/le-corps-des-arrivants.md` · ❓ Une blessure prise ici s'efface-t-elle en repassant sous l'âge où elle a été prise ?

**L'instrument.** Outil du veilleur. Il donne l'âge d'un corps déjà sorti, une fois pour
toutes. **Il ne prédit rien, ne lit rien d'une capsule fermée, et ne se trompe pas** — et il
ne dit pas de quel côté du plateau on se trouve. **Hors du glossaire : on sait ce qu'est un
instrument.**
...
finissent par produire le même. **Hors du glossaire : tout le monde sait ce qu'est un
numéro.**
> `02-univers/la-ruche.md` · ❓ Suit-il l'ordre des arrivées ? Laisse-t-il un trou quand une capsule n'éclaircit pas ? Sa forme n'est pas fixée.

**Le pacte.** Ce qui tient le tabou : chacun finira sa vie inutile et dépendant, entretenu
par les autres — les élus compris, qui voteraient donc sur le lieu où ils finiront. **Avec le
jardin, ce n'est plus un raisonnement mais une adresse : on sait dans quel bâtiment.**
> `02-univers/le-jardin.md` · ❓ Il ne tient plus sur une échéance connue depuis que la fin des grands chiffres est indatable. Correction en attente sur le dossier maître.

**« Les petits princes pourris du jardin ».** Insulte du milieu jaloux visant les arrivants
jeunes. *Petits princes* pour l'accès sans mérite, *pourris* au sens de gâtés, *du jardin*
pour le lieu où eux n'iront que très tard et pour très peu de temps. **Hors du glossaire :
c'est une réplique, pas une entrée** — décision de l'autrice, 20 août 2026.
> `02-univers/la-jalousie.md` · ❓ Où elle se dit, et combien de fois.

**Le plateau.** La phase du décompte où l'âge s'arrête à huit ans, pour un temps qui varie
...
> `02-univers/les-ages-croises.md`

**Le relevé.** Geste de métier du veilleur : mesurer l'avancée de l'éclaircie au fil des
...
*On ne se rappelle pas ce qu'on a été, on y retourne.* Il agit sur le corps, jamais sur la
pensée.
> `02-univers/le-corps-des-arrivants.md`
...
d'une ceinture. **C'est le premier vêtement d'un arrivant.** Quatre tailles à l'office, et on
...
qu'une seule planète.** *Son histoire s'apprend par la petite porte, dans une leçon où
personne n'explique rien — la guerre du Sud, la seconde guerre des côtes, l'année des
greniers vides.*
> `02-univers/la-terre.md` · ❓ Le rythme des scènes d'histoire : combien de fois avant que le procédé se voie.

**La tenue.** Vêtement de travail du service : une blouse de toile écrue croisée sur le
devant, six boutons sur le côté droit, l'écusson brodé sur l'épaule opposée, deux poches
basses, une ceinture à crans. Claire, et **on en change dès qu'elle est marquée** — *c'est ce
qui arme le « tu aurais pu changer de tenue ! » de la seconde cérémonie.*
> `02-univers/la-ruche.md` · ❓ La porte-t-il en ville ? C'est ce qui lui ouvre des portes sans mandat.
