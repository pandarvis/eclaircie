...
> **Le jeu de piste de l'autrice, 18 août 2026. Il remplace intégralement les treize beats génériques de cette section.** La méthode (§1), le déclencheur (§4) et les beats en double (§5) sont inchangés ; le parcours, lui, est celui-ci et rien d'autre.
